...
part of 'connectivity_check_store.dart';
...
mixin _$ConnectivityCheckStore on ConnectivityCheckStoreBase, Store {
  late final _$connectivityStreamAtom = Atom(
      name: 'ConnectivityCheckStoreBase.connectivityStream', context: context);
